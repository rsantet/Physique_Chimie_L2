    ...
    \subsection[Distributions discrètes ou continues de charges]{Distributions discrètes ou continues de charges. Densité volumique de charge}
        ...
        \subsubsection{Modèles surfacique et linéique}
            ...
            \paragraph{Distribution de charges en surface : \og nappe\fg~ de charge.}
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}[scale=1]  
                        ...
                        \draw [latex-latex] (-2,1.1)--(-1,1.1) node [above, midway] {$\d S$};
                        ...
                        \draw [draw=blue, text=blue, very thick] (3.5,0.5)--++(1,0) node [above,midway] {$\delta Q=\sigma \d S$};
                    \end{tikzpicture}
            ...
            \paragraph{Distribution linéique de charges.}
                ...
                On considère la Figure~\ref{fig:modele_lineique_distribution_charge}. Il y a $\delta Q=\rho S\d l$ charges dans la volume bleu. On définit alors la \textbf{densité linéique de charge} $\lambda=\rho S$, d'unité \si{\coulomb\per\metre}. On a alors
                \begin{equation}
                    \boxed{
                        \delta Q=\lambda\d l.
                    }
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}[scale=1]  
                        ...
                        \draw [draw=blue, text=blue, very thick] (10,0.5)--++(1,0) node [above,midway] {$\delta Q=\lambda \d l$};
            ...
            \paragraph{Cas à une dimension et un seul type de porteur libre.}
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}[scale=1]  
                        ...
                        \draw[latex-latex,draw=blue,text=blue] (-2,1.5)--(0,1.5) node [above, midway] {$V\d t$};
                ...
                Le nombre $\delta N$ de porteurs traversant (S) pendant $\d t$ est 
                \begin{equation}
                    \delta N=n S v\d t=n\vec{v}\cdot(S\vec{n})\d t,
                \end{equation}
                d'où 
                \begin{equation}
                    \delta Q=\delta N\times q=nq\vec{v}\cdot(S\vec{n})\d t
                \end{equation}
                et finalement 
                \begin{equation}
                    \boxed{
