\section[Diagramme d'état et machines réelles]{Diagramme d'état \texorpdfstring{$(\log P,h)$}{(log P,h)} d'un fluide pur et fonctionnement de machines thermiques réelles}
    ...
    \subsection{Exemple : cycle moteur à vapeur d'une centrale électrique}
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}[scale=1,decoration={
                ...
                \draw (1,3.75) rectangle (3,4.25) node[midway] {chaudière};
    ...
    \subsection{Réfrigérateur à compresseur}
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}[scale=1,decoration={
                ...
                \draw[postaction={decorate}] (A2)--(B);
                \coordinate (B1) at (1,4);
                \draw (1,3.75) rectangle (3,4.25) node[midway] {condenseur};
                \coordinate (B2) at (3,4);
                \coordinate (C) at (4,4);
                \draw[postaction={decorate}] (B)--(B1);
                \draw[postaction={decorate}] (B2)--(C);
                ...
                \coordinate (D1) at (3,0);
                \coordinate (D2) at (1,0);
                \draw (1,-0.25) rectangle (3,0.25) node[midway] {\small évaporateur};
                \draw[postaction={decorate}] (D)--(D1);
                \draw[postaction={decorate}] (D2)--(A);
